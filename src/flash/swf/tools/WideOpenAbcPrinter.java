 ...
 */
public class WideOpenAbcPrinter 
{
	protected byte[] abc;
    protected PrintWriter out;
    protected boolean showOffset;
    protected boolean showByteCode;
    ...
    public WideOpenAbcPrinter(byte[] abc, PrintWriter out, boolean showOffset, int indent, boolean showByteCode)
    {
        this.abc = abc;
        this.out = out;
    ...
    class MethodInfo
    {
        ...
        protected Object clone() {
        	...
        	if(optionKinds!=null)
        		info.optionKinds = optionKinds.clone();
        	if(optionIndex != null)
        		info.optionIndex = optionIndex.clone();
        	if(paramNames != null)
        		info.paramNames = paramNames.clone();
